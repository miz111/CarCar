...
class AppointmentEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      customer_name: this.props.params.customer_name,
      date: this.props.params.date,
      time: this.props.params.time,
      reason: this.props.params.reason,
      technician: this.props.params.technician,
      technicians: [],
      success: false,
      failedAttempt: false,
    };
  ...
  async handleSubmit(event) {
    ...
    const appointmentUrl = `http://localhost:8080/api/appointments/${this.props.params.id}/`;
    const fetchConfig = {
      method: "put",
    ...
    return (
      <div className="row">
        <div className="offset-3 col-6">
          ...
          >
            The appointment has been edited.
          </div>
...
export default withExtras(AppointmentEdit);
